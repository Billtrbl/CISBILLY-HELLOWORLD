...
public class HangmanProject {
	...
	private void guess(BufferedWriter writer, String word, int life) {
		...
		System.out.println("          the number of guesses you have left = " + life); // number of guesses available
																						// before game over
	...
	public static void main(String[] args) {
		...
		try {
			writer = new BufferedWriter(new FileWriter("Hangman Result9.txt")); // the result of whether or not the
																				// player wins will print out here
			...
			do {
				...
				do { // check the user's input
					System.out.println("Type 0 to play again. Type 1 to quit."); // to prompt player whether or not they
																					// want to continue or to end the
																					// game
					writer.write("Type 0 to play again. Type 1 to quit.");
					replay = s.next().charAt(0);
					if (replay != '0' && replay != '1') {
						System.out.println("Input not recognized "); // will show if the player enters int other than 1
																		// or 0
